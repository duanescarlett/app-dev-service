  ...
  return (
    <section className="w-full py-20">
        <h1 className="heading">
            Our <span className="text-purple">Development Process</span>
        </h1>
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        <Card 
            ...
            icon={<AceternityIcon
                order="Phase 2"
            />} 
            description="Once we agree on the approach, we dive into coding. From initial sketches to polished code, We keep you updated every step of the way.">
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card 
            ...
            icon={<AceternityIcon
                order="Phase 3"
            />} 
            description="This is where the magic happens! Based on the approved designs and functions, we&apos;ll translate everything into functional code, building your application from the ground up.">
          <CanvasRevealEffect
            animationSpeed={3}
